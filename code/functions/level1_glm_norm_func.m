function level1_glm_norm_func(subs)    
    ...
    for sub = 1:length(subs)
        ...
        if ~exist(fullfile(fmriPath, subID, 'derivatives/loc_glm1_norm'), 'dir')
            mkdir(fullfile(fmriPath, subID, 'derivatives/loc_glm1_norm'));
        end
    
        % model specification
        matlabbatch{1}.spm.stats.fmri_spec.dir = {fullfile(fmriPath, subID, 'derivatives/loc_glm1_norm')};
        ...
        locFiles = dir( ...
            fullfile( ...
                ...
                subID, ...
                'func', ...
                sprintf('wr%s_task-localizer_bold_*.nii', subID) ...
            ) ...
        );
        ...
        if ~exist(fullfile(fmriPath, subID, 'derivatives/exp_glm1_norm'))
            mkdir(fullfile(fmriPath, subID, 'derivatives/exp_glm1_norm'));
        end
    
        % model specification
        matlabbatch{1}.spm.stats.fmri_spec.dir = {fullfile(fmriPath, subID, 'derivatives/exp_glm1_norm')};
        matlabbatch{1}.spm.stats.fmri_spec.timing.units = 'secs';
        matlabbatch{1}.spm.stats.fmri_spec.timing.RT = 1.85;
        matlabbatch{1}.spm.stats.fmri_spec.timing.fmri_t = 16;
        matlabbatch{1}.spm.stats.fmri_spec.timing.fmri_t0 = 8;
        ...
        for run = 1:7
            expFiles = dir( ...
                fullfile( ...
                    ...
                    subID, ...
                    'func', ...
                    sprintf('wr%s_task-scenes_run-%s_bold_*.nii', subID, num2str(run)) ...
                ) ...
            );
